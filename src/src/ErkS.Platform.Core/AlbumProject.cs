...
{
    /// <summary>Stable project-team participant identity. Empty only for legacy album files.</summary>
...
public sealed class AlbumDefinition
{
    ...
    /// <summary>
    /// Project-owned common format for pages generated by Studio. Received
    /// source sheets keep their own page format and placement settings.
    /// </summary>
    public PageFormatDefinition? GeneratedPageFormat { get; set; }
...
public sealed class AlbumCompositionItem : IAlbumPageRoleOwner
{
    ...
    /// <summary>Per-page title-block people selected from the project team.</summary>
    public List<AlbumPageRoleAssignment> RoleAssignments { get; set; } = [];
}
...
public sealed class AlbumPageDefinition : IAlbumPageRoleOwner
{
    public Guid Id { get; set; } = Guid.NewGuid();
